...
<html>
<head>
    <title>Edit Buku - MVC OOP PHP</title>
    <style>
        :root {
            --primary-blue: #3498db;
            --dark-blue: #2980b9;
    ...
    <div class="form-card">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" name="nm_buku" value="<?php echo $row[1] ?>" placeholder="Masukkan nama buku" required>
            </div>
            
            <div class="form-group">
                <label for="pengarang">Pengarang Buku</label>
                <input type="text" name="pg_buku" value="<?php echo $row[2] ?>" placeholder="Masukkan nama pengarang" required>
            </div>
            
            <div class="form-group">
                <label for="penerbit">Penerbit Buku</label>
                <input type="text" name="pn_buku" value="<?php echo $row[3] ?>" placeholder="Masukkan nama penerbit" required>
            </div>
            
            <div class="form-group">
                <label for="tahun">Tahun Terbit Buku</label>
                <input type="text" name="thn_buku" value="<?php echo $row[4] ?>" placeholder="Masukkan tahun terbit" required>
            </div>
