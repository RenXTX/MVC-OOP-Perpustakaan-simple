<?php
//pembuatan kode anggota otomatis
...
<html>
<head>
    <title>Tambah Anggota - MVC OOP PHP</title>
    <style>
        :root {
            --primary-blue: #3498db;
            --dark-blue: #2980b9;
    ...
    <div class="form-card">
        ...
        <form action="" method="POST">
            <div class="form-group">
                ...
                <input type="text" name="kd_anggota" value="<?php echo $id ?>" readonly>
            </div>
            
            <div class="form-group">
                <label for="namaa">Nama Anggota</label>
                <input type="text" name="nm_anggota" placeholder="Masukkan nama anggota" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="notel" placeholder="Masukkan nomor telepon" required>
            </div>
            
            <div class="form-actions">
                <button type="submit" name="submit" class="btn btn-submit">
                    <i class="fas fa-user-plus"></i> Simpan Data
                </button>
