...
<body>
    <div class="container">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action-buttons">
                        <a href='index.php?ep=<?php echo $row['kode_pinjam'] ?>' class="btn btn-edit">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <a href='index.php?dp=<?php echo $row['kode_pinjam'] ?>' class="btn btn-delete" onClick="return confirm('Hapus Data?')">
        ...
        <div class="nav-links">
            <a href='index.php?ip=tambah_pinjam' class="nav-link">
                <i class="fas fa-plus-circle"></i> Tambah Data Pinjam
            </a>
